...
namespace GainIt.API.Services.Tasks.Interfaces
{
    ...
    {
        Task<IReadOnlyList<ProjectMilestoneViewModel>> GetMilestionesListAsync(Guid i_ProjectId);
        Task<ProjectMilestoneViewModel?> GetMilestoneAsync(Guid i_ProjectId, Guid i_MilestoneId);
