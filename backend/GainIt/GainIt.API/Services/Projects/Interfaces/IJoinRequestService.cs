...
namespace GainIt.API.Services.Projects.Interfaces
{
    ...
    {
        Task<JoinRequest> CreateJoinRequestAsync(Guid i_ProjectId, Guid i_RequesterUserId, string i_RequestedRole, string? i_Message);
        ...
        Task<JoinRequest> GetJoinRequestByIdAsync(Guid i_ProjectId, Guid i_JoinRequestId, Guid i_UserId);
    }
